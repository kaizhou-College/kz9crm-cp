...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			<img onclick="to('${basepath}/html/salchance_todispatch.action');" title="指派" src="${basePath}/html/images/bt_linkman.gif" class="op_button" />
			
			
			<img onclick="to('edit.html');" title="编辑" src="${basePath}/html/images/bt_edit.gif" class="op_button" />
			<img id="chance_del" title="删除" src="${basePath}/html/images/bt_del.gif" class="op_button" />
