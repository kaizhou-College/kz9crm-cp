...
<form action="${basePath}html/cstService_superselect2" method="post">
...
<table class="data_list_table">
	...
	<tr>
		...
		<td class="list_data_op">
			<img onclick="to('${basePath}html/cstService_todetail?svrId=<s:property value="#cstServicelist.svrId"/>');" title="处理" src="${basePath}/html/images/bt_deal.gif" class="op_button" />  
