...
public class CstCustomer implements java.io.Serializable {
	...
	private Set<CstActivity> cstActivity=new HashSet<CstActivity>();
	...
	public CstCustomer(String custNo, String custName, String custRegion,
			Integer custManagerId, String custManagerName,
			Integer custLevel, String custLevelLabel, Integer custSatisfy,
			...
			String custTurnover, String custBank, String custBankAccount,
	...
	public void setCstService(Set<CstService> cstService) {
		this.cstService = cstService;
	}

	public Set<CstActivity> getCstActivity() {
		return cstActivity;
	}

	public void setCstActivity(Set<CstActivity> cstActivity) {
