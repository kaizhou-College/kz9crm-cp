...
<form  id="frm" action="${basePath}html/sysUser_login" method="post">
<table width="100%">
        <tr> 
          <th>用户名</th>
          <td><input size="10" value="hlliu" maxlength="20" id="usrName" name="sysUser.usrName"/></td>
        </tr>
        <tr> 
          <th>密码</th>
          <td><input type="password" size="10" maxlength="20" id="usrPassword" value="123" name="sysUser.usrPassword"/></td>
        </tr>
        <tr> 
          <td>&nbsp;</td>
